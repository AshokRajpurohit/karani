...
/**
 * This is an improvement over {@link ReadersWriters} with priority given to writers.
 * If there are multiple writers waiting and a new writer joins the queue, he is given
 * preference over already waiting readers.
 * Priority can be handled at java thread level also. higher priority can be given to writer threads
 * as compared to reader threads and scheduler will take care of it.
 * Here I present the solution from the book where we don't have the facility of thread priority.
 *
...
public class ReadersWritersPriority {
    ...
    public static void main(String[] args) throws IOException {
        ReadersWritersPriority a = new ReadersWritersPriority();
        try {
            a.solve();
        } catch (Exception e) {
            e.printStackTrace();
