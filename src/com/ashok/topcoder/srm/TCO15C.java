...
public class TCO15C {
    ...
    public void solve() throws IOException {
        ...
        DevuAndPlantingTrees ob = new DevuAndPlantingTrees();

        while (true) {
            String[] ar = new String[2];
            ar[0] = in.read();
            ar[1] = in.read();
            System.out.println(ob.maximumTreesDevuCanGrow(ar));
        }
    }
    ...
    class DevuAndPlantingTrees {
        int maximumTreesDevuCanGrow(String[] garden) {
            ...
            for (int i = 0; i < garden[0].length(); ) {
                if (garden[0].charAt(i) == '*' || garden[1].charAt(i) == '*')
                    i += 2;
                else if (i < garden[0].length() - 1 &&
                         (garden[1].charAt(i + 1) == '*' ||
                          garden[1].charAt(i + 1) == '*')) {
                    i += 3;
                } else if (i > 0 &&
                           (garden[0].charAt(i - 1) == '*' || garden[1].charAt(i -
                                                                               1) ==
                            '*')) {
                    i++;
                } else {
