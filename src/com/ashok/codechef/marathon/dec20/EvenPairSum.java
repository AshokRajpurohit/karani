...
/**
 * Problem Name: Even Pair Sum
 * Link: https://www.codechef.com/DEC20A/problems/EVENPSUM
 * <p>
...
class EvenPairSum {
    ...
    private static long process(int a, int b) {
        return 1L * evenCount(a) * evenCount(b) + 1L * oddCount(a) * oddCount(b);
    }

    private static int evenCount(int n) {
        return n >>> 1;
    }

    private static int oddCount(int n) {
        return (n + 1) >>> 1;
    }
