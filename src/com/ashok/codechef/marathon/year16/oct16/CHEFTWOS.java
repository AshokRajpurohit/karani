...
/**
 * Problem Name: Chef and Two String
 * Link: https://www.codechef.com/OCT16/problems/CHEFTWOS
 *
...
class CHEFTWOS {
    ...
    private static void solve() throws IOException {
        ...
        while (t > 0) {
            ...
            out.println(process(in.read().toCharArray(), in.read().toCharArray()));
        }
    }
    ...
    private static int nextStateIndex(int stateIndex, int value) {
        State state = states[stateIndex].nextState(value);

        return state.a + state.b;
    }

    /**
     * Enum {@code State} has two state variables, a and b.
     * if the string is ending at b then a is zero (to indicate
     * the end state, although it is invalid value). If a is not
     * zero then a and b represent the last two point states when b is
     * not the end point.
     * The valid states can be
     * <p>
     * (2, 1) when it is like (**221) and from b(1) the dog jumps to
     * a(2).
     *
     * (2, 2) when it is like (**22) and dog is at the first 2 and second
     * 2 is still unvisited.
     */
    enum State {
