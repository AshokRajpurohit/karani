...
class PATHS {
    ...
    private static Grid[] grids = new Grid[1000000];
    ...
    public void solve() throws IOException {
        ...
        while (t > 0) {
            t--;
            BigInteger bi = new BigInteger(in.read());
            process(sb, bi);
        }
    }

    private static void process(StringBuilder sb, BigInteger bi) {
        // lol
    }

    final static class Grid implements Comparable<Grid> {
        int n, r;
        BigInteger ncr;

        public int compareTo(Grid o) {
            return ncr.compareTo(o.ncr);
        }
    }
