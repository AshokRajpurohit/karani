...
public class July15B {
    ...
    public void solve() throws IOException {
        ...
        while (t > 0) {
            ...
            out.println(process(n, k, x, y));
        }
    }

    private static long process(int n, int k, int[] x, int[] y) {
        long res = 1L * n * n, phool = 0;
        int[] plusDiag = new int[n * 2];
        int[] minusDiag = new int[n * 2];
