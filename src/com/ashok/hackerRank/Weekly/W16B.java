 ...
 * problem: Devu and Lucky Numbers
...
public class W16B {
    ...
    private static long[] fact = new long[301], invers =
        new long[101], powOfTen = new long[301];
    ...
    private static long process(int x, int y, int z) {
        // code here
        return 4; // dummy
    }
