...
public class BearAndCryptography {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BearAndCryptography a = new BearAndCryptography();
        a.solve();
        out.close();
    }
    ...
    public void solve() throws IOException {
        ...
        while (t > 0) {
            out.println(process(in.readLong(), in.readInt()));
        }
    }
    
    private static long process(long n, int k) {
        if (k == 1)
            return 1;
