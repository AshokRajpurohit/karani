...
public class HourRank5XorSequence {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HourRank5XorSequence a = new HourRank5XorSequence();
        a.solve();
        out.close();
    }
    ...
    public void solve() throws IOException {
        ...
        while (t > 0) {
            t--;
            sb.append(calculate(in.readLong(), in.readLong())).append('\n');
        }
        out.print(sb);
    }
    ...
    private static long calculate(long a, long b) {
        ...
        if (a % 2 == 0) {
            ...
            res ^= 2 * (getXor(c) ^ getXor(a - 1));
            return res;
        }


        res ^= getXor(c) ^ getXor(a - 1);
        a++;
        c--;
