 ...
 * CodeJam 2015 Qualification Round | Problem A. Standing Ovation
 */
...
public class A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //
        String input = "A.in", output = "A.out";
    ...
    public void solve() throws IOException {
        ...
        for (int i = 1; i <= t; i++) {
            int s_max = in.readInt();
            String shy = in.read();
            sb.append(format).append(i).append(": ");
            sb.append(solve(s_max, shy)).append('\n');
        }
        out.print(sb);
    }

    private static int solve(int s_max, String s) {
        int res = 0;
        int count = 0;
